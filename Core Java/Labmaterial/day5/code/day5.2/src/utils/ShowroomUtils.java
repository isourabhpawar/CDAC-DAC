...
//Add a static method to return populated list(sample hardcoded data) of vehicles
	public static List<Vehicle> populateShowroom() {
		try {
			...
			vehicles.add(validateAllInputs("abc-1239", "white", 395678, "2023-02-24", "Honda", vehicles));
			...
			vehicles.add(validateAllInputs("abc-1240", "black", 305678, "2023-03-01", "Maruti", vehicles));
			return vehicles;
		} catch (Exception e) {
			e.printStackTrace();
		}
