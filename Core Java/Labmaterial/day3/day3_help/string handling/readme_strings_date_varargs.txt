...
String class methods --- to go through using java docs
...
var-args  ... (ellipsis)
variable args syntax : Allows to pass  variable no. of arguments to the method

Rules : 
It must be last argument in the method argument list
One can use var-args syntax with , primitive type as well as ref types.
...
Java API example of var-args
printf method of java.io.PrintStream

System.out.printf("%n");//legal 
System.out.printf(1234);//javac error
System.out.printf("Id %d Name %s Salary %8.2f %n",id,name,salary);



More practice :

void doStuff2(char c, int... x) {..... } //=> must supply 1 char n 0 ints or int[] or , sep. ints
eg : ref.doStuff2('a',1,2,3,5);//legal
ref.doStuff2();//illegal : javac err


Can you use var-args syntax , with ref types ? 
Yes
...
What will happen ?
In the Tester class's main method : 
Test ref=new Test();
ref.doStuff3();//legal
Animal animals[]={new Cat(),new Dog(),new Horse()}; //4 objs
ref.doStuff3(animals);//legal
Animal a1=new Horse(); 
Animal a2=new Cat(); 
Animal a3=new Dog();
ref.doStuff3(a1,a2,a3);//legal

What will happen ?
void doStuff4(int x...) {....}  //illegal syntax
void doStuff5(int... x, char... y) {...} //illegal syntax
void doStuff6(String... s, byte b) { } //illegal syntax
